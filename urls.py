...
urlpatterns = patterns('',
                       ...
                       url(r'^activity/participant/list$', 'services.views.list_activity_participants_route'),
                       ...
                       url(r'^activity/report$', 'services.views.activity_statistics_route'),
                       ...
                       url(r'^activity/resource/parameter/create/fromdefault$', 'services.views.create_activity_resource_parameter_from_default_route'),
                       url(r'^activity/resource/parameter/list$', 'services.views.list_activity_resource_parameters_route'),
                       url(r'^contractor/create$', 'services.views.create_contractor_route'),
                       url(r'^contractor/list$', 'services.views.list_contractors'),
                       url(r'^contractor/project/resource/list$', 'services.views.contractor_list_project_resources_route'),
                       url(r'^contractor/resource/offer$', 'services.views.contractor_offer_resource_route'),
                       ...
                       url(r'^participant/report$', 'services.views.participant_statistics_route'),
