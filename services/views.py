...
def list_projects_route(pars):  # ++TESTED
    ...
    **Список проектов**
    ...
    - `page_number`: номер страницы начиная с 0, если не указан, возвращает первую
    ...
    - `pages`: (целое) число страниц при указанном количестве проектов на страницу, если количество проектов не указано, возвращает количество проектов вообще, то есть совпадает с длинной списка `projects`
